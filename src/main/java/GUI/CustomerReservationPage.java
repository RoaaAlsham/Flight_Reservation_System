...
public class CustomerReservationPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btn_ConfirmReservation = new javax.swing.JButton();
        ...
        showAllAvailableFlights.setBackground(new java.awt.Color(255, 153, 204));
        showAllAvailableFlights.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        showAllAvailableFlights.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Grey"));
        ...
        lbl_originCity.setForeground(new java.awt.Color(102, 0, 102));
        ...
        btn_calculateReservationPrice.setBackground(new java.awt.Color(153, 255, 204));
        btn_calculateReservationPrice.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btn_calculateReservationPrice.setForeground(javax.swing.UIManager.getDefaults().getColor("Actions.Grey"));
        ...
        lbl_price.setForeground(new java.awt.Color(0, 102, 102));
        lbl_price.setText("price: .....");

        btn_ConfirmReservation.setBackground(new java.awt.Color(255, 153, 204));
        btn_ConfirmReservation.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        btn_ConfirmReservation.setText("Confirm Reservation");
        btn_ConfirmReservation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ConfirmReservationActionPerformed(evt);
            }
        });

        btn_logoutCustomer.setBackground(new java.awt.Color(153, 255, 204));
        btn_logoutCustomer.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        btn_viewHistory.setBackground(new java.awt.Color(153, 255, 204));
        ...
        jLabel4.setText("please select a flight from table above");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(79, 79, 79)
                            .addComponent(btn_ConfirmReservation))
                        .addGroup(layout.createSequentialGroup()
    ...
    private void btn_ConfirmReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ConfirmReservationActionPerformed
        if (flightsTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(mainFrame, "please select a flight to continue");
            return;
        }
        ...
        if (agree == JOptionPane.OK_OPTION) {
            ...
            //reservations are added to reservation list, flight list, customer list
            flightDataLists.getReservations().add(reservation);
            LoggedinCustomer.getCustomerReservations().add(reservation);
            flight.getReservations().add(reservation);
            flight.getReservedSeats().addAll(reservedSeats);
    ...
    }//GEN-LAST:event_btn_ConfirmReservationActionPerformed
    ...
    private void btn_viewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_viewHistoryActionPerformed
        // TODO add your handling code here:
        CustomerHistory customerHistory = new CustomerHistory(mainFrame, flightDataLists, LoggedinCustomer);
        mainFrame.mainPanel.add(customerHistory, "CustomerHistory");
        mainFrame.showPanelMethod("CustomerHistory");
    ...
    private javax.swing.JButton btn_ConfirmReservation;
